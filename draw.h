...
void draw_textured_flat_shaded(const sdl_gfx* gfx, const vec3_t* vertices, const triangle_t* tris, int tris_count, const vec2_t* uvs, const texture_t* texture, light_t light, const mat4x4_t* proj_mat, projection_type proj_type, z_buffer_t* z_buffer);
void draw_textured_phong_shaded(const sdl_gfx* gfx, const vec3_t* vertices, const vec3_t* normals, const triangle_t* tris, int tris_count, const vec2_t* uvs, const texture_t* texture, light_t light, const mat4x4_t* proj_mat, projection_type proj_type, z_buffer_t* z_buffer);
